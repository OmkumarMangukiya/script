...
class N8NWorkflowProcessor:
    ...
    def prepare_chat_messages(self, workflow: Dict[str, Any]) -> List[Dict[str, str]]:
        ...
        system_message = "You are an expert in N8N workflows. Generate exactly 3 diverse training prompts for the given workflow."
        ...
        try:
            ...
            try:
                ...
                if not isinstance(prompts, list) or len(prompts) != 3:
                    raise ValueError(f"OpenAI response is not a valid list of 3 prompts. Response: {content}")
                return prompts
